...
Page.prototype.bindNavigation = function () {
    ...
    $("#my-reservations").click(function () {
        $.post("http://localhost:5005/api/reservation/user/" + that.name, function (data) {
    ...
    $("#catalog").click(function () {
        $.post("http://localhost:5005/api/catalog", function (data) {
            ...
            for (var x = 0; x < data.length; x++) {
                ...
                html += "<td><a href=\"http://localhost:5005/api/reservation/user/{user}/book/" + data[x].bookId + "\" class=\"reserve-link\">Reserve</a></td>";
                html += "</tr>";
            }
            html += "</table>";
